...
function fun1() {
    ...
    if (chbox.checked) {
        function filterArray1(arr){
            let filterArrayFalse = usersWithAddress.filter(value => value.status===false)
            console.log(filterArrayFalse)
            let div = document.createElement('div')
            for (let filterElement of filterArrayFalse) {
...
function fun2() {
    let chbox;
    chbox=document.getElementById('2');
    if (chbox.checked) {
        function filterArray2(arr){
            let filterArrayFalse = usersWithAddress.filter(value => value.age>'29')
            console.log(filterArrayFalse)
            let div = document.createElement('div')
            for (let filterElement of filterArrayFalse) {
                let li = document.createElement('li')
...
function fun3() {
    let chbox;
    chbox=document.getElementById('3');
    if (chbox.checked) {
        function filterArray3(arr){
            let filterArrayFalse = usersWithAddress.filter(value => value.address.city==='Kyiv')
            console.log(filterArrayFalse)
            let div = document.createElement('div')
            for (let filterElement of filterArrayFalse) {
                let li = document.createElement('li')
